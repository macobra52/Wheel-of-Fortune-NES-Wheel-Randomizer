...
-- Tested with Wheel of Fortune (U), Wheel of Fortune: Junior Edition (U), and Wheel of Fortune Gamer Edition. May not properly work with other romhacks
...
local wheelStart = 0x3FB;
local wheelFinish = 0x412;
local currentRoundAddress = 0xBE;
local spinAddress = 0xAF;
...
while (true) do
	if romCheck == false then
		print("Wheel of Fortune (NES) Wheel Randomizer, by MaCobra52");
